...
<section class="tp-banner-container">
            <div class="tp-banner">
                <div style="margin-left:300px;height:10px;">
                    <img src="{{ asset('images/sproviders/4.jpg') }}" style="height:200px;margin-left:100px;margin-top:30px;">
                </div>
                ...
                <div class="filter-header">
                    <form id="sform" action="{{route('searchService')}}" method="post">   
                        ...
                        <input type="text" id="q" name="q" required="required" placeholder="What Services do you want?"
                            class="input-large typeahead" autocomplete="off"  style="width: 455px;"><br><br><br>
                        <input type="submit" name="submit" value="Search" style="margin-left: 332px ; margin-top:-72px;">
                    </form>
                </div>
            </div>
        </section>
            ...
            <div class="content_info">
                <div>
                    <div class="container">
                        <div class="row">
                            <div class="titles">
                                <h2> <span>Choose</span>        Your<span> Service </span>
                            </h2>
                ...
                <div id="boxes-carousel">
                    ...
                    <div>
                        <a class="g-list" href="{{route('home.service_details',['service_slug'=>$aservice->slug])}}">
                            <div class="img-hover">
                                <img src="{{asset('images/services/thumbnails')}}/{{$aservice->thumbnail}}" alt="{{$aservice->image}}" class="img-responsive">
                            </div>
