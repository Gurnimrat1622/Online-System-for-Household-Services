...
<div class="section-title-01 honmob">
        ...
        <div class="content-central">
            ...
            <div class="content_info" style="margin-top:-300px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <aside>
                                    <h4>The Office</h4>
                                    <address>
                                        <strong>ServiceProviders Home Services.</strong><br>
                                        <i class="fa fa-map-marker"></i><strong>Address: </strong>Jalandhar, Punjab,
                                        India<br>
                                        <i class="fa fa-phone"></i><strong>Phone: </strong> +91-1234567890
                                    </address>
                                    <address>
                                        <strong>ServiceProviders Emails</strong><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:contact@serviceProviders.in">contact@serviceProviders.in</a><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:support@serviceProviders.in"> support@serviceProviders.in</a>
                                    </address>
                                </aside>
                                <hr class="tall">
                            </div>
